...
VALUES (
        ...
        'We want to inform you that the price of gold per ounce has reached a threshold value. As of @alertDateTime, the current price is @$goldPrice per ounce.\n' ||
        ...
        ARRAY['@firstName', '@lastName', '@alertDateTime', '@goldPrice']
       );