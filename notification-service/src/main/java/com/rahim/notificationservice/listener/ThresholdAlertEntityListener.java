package com.rahim.notificationservice.listener;
...
@Component
public class ThresholdAlertEntityListener {
    private static final Logger LOG = LoggerFactory.getLogger(ThresholdAlertEntityListener.class);
